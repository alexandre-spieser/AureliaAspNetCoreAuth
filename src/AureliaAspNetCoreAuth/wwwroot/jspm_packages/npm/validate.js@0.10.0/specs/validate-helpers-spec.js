  ...
  describe("validate", function() {
    ...
    describe("unique", function() {
      ...
      it("filters non unique values", function() {
        expect(validate.unique(["foo", "bar", "bar", "foo", "baz"])).toEqual(["foo", "bar", "baz"]);
        expect(validate.unique(["foo", "foo", "foo"])).toEqual(["foo"]);
        expect(validate.unique([1, 2, 3, 3, 2, 1])).toEqual([1, 2, 3]);
      });
